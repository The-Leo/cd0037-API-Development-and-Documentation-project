...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://postgres:abc@{}/{}".format('localhost:5432', self.database_name)
...
#Test for returning error, 'not found'
...
#Test for if questions does not exist
...
#Test for if question creation is not allowed
...
# Test for 404 error if there is no category found
    def test_404_error_for_category_not_found(self):
...
# Test for  422 error if there is no question found to be deleted
...
# Test for category questions failing
